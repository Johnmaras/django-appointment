...
import appointment.utils.view_helpers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot_duration', models.PositiveIntegerField(
                    help_text='Minimum time for an appointment in minutes, recommended 30.', null=True)),
                ...
                ('app_offered_by_label', models.CharField(
                    default='Offered by', help_text='Label for `Offered by` on the appointment page', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('active', 'Active'), ('verified', 'Verified'), ('invalidated', 'Invalidated')],
                    default='active', max_length=11)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DurationField(
                    validators=[django.core.validators.MinValueValidator(datetime.timedelta(seconds=1))])),
                ...
                ('background_color', models.CharField(
                    blank=True, default=appointment.models.generate_rgb_color, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_time', models.TimeField(
                    blank=True, help_text='Time when the staff member starts working.', null=True)),
                ('finish_time', models.TimeField(
                    blank=True, help_text='Time when the staff member stops working.', null=True)),
                ('appointment_buffer_time', models.FloatField(
                    blank=True, null=True,
                    help_text='Time between now and the first available slot for the current day.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_member', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, to='appointment.staffmember')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_for_rescheduling', models.TextField(
                    blank=True, help_text='Reason for the appointment reschedule.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_request', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE, to='appointment.appointmentrequest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='appointment.appointment')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('staff_member', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='appointment.staffmember')),
            ],
        ),
        migrations.CreateModel(
            name='WorkingHours',
